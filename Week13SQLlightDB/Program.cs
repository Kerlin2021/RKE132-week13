...
//ertCustomer(CreateConnection());
RomoveCustomer(CreateConnection());
...
static void IsertCustomer(SQLiteConnection myConnection)
{
    SQLiteCommand command;
    string fName, lName, dob;

    Console.WriteLine("Enter firtstname");
...
static void RomoveCustomer (SQLiteConnection myconnection)
{
